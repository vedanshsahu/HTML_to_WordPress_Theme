        ...
        <div class="feature-work container my-4">
            <div class="row d-flex d-flex align-items-center">
                ...
                <div class="col-lg-6 offset-lg-1 align-left">
                    <div class="row">
                        <a class="col" data-type="image" data-fslightbox="gallery" href="<?php echo  get_template_directory_uri() . '/assets/img/feature-work-1.jpg' ?>">
                            <img class="img-fluid" src="<?php echo  get_template_directory_uri() . '/assets/img/feature-work-1.jpg' ?>">
                        </a>
                        <a class="col" data-type="image" data-fslightbox="gallery" href="<?php echo  get_template_directory_uri() . '/assets/img/feature-work-2.jpg' ?>">
                            <img class="img-fluid" src="<?php echo  get_template_directory_uri() . '/assets/img/feature-work-2.jpg' ?>">
                        </a>
                    </div>
                    <div class="row pt-4">
                        <a class="col" data-type="image" data-fslightbox="gallery" href="<?php echo  get_template_directory_uri() . '/assets/img/feature-work-3.jpg' ?>">
                            <img class="img-fluid" src="<?php echo  get_template_directory_uri() . '/assets/img/feature-work-3.jpg' ?>">
                        </a>
                        <a class="col" data-type="image" data-fslightbox="gallery" href="<?php echo  get_template_directory_uri() . '/assets/img/feature-work-4.jpg' ?>">
